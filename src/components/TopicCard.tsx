...
export default function TopicCard({ topic, index, onClick }: Props) {
  ...
  return (
    <div
      ref={ref}
      onClick={onClick}
      className="relative group cursor-pointer p-6 md:p-10 transition-all duration-300"
      style={{
        background: '#1a1a1a',
    ...
    >
      <div className="relative z-10">
        ...
        <div className="text-4xl mb-8">{topic.emoji}</div>
        ...
        <div className="mt-8 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <span
